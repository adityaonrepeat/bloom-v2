  ...
  return (
    ...
    <nav className="w-full h-16 bg-white/80 backdrop-blur-md border-b border-stone-200/60 flex items-center justify-between px-10 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Notification bell */}
        <button className="p-2 rounded-lg hover:bg-stone-50 transition-colors text-stone-400 hover:text-stone-600">
        ...
        {/* Avatar */}
        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-200 to-teal-200 flex items-center justify-center border-2 border-white shadow-sm">
